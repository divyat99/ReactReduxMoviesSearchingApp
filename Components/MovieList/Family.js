...
useEffect(() => {
  const fetchDataFromAPI = async () => {
    try {
      const family = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=cfe422613b250f702980a3bbf9e90716&page=${pageNo}&sort_by=popularity.desc&with_genres=10751&year=1988`);
              const data1 = await family.json();
        ...
        dispatch(setApiData({family:combinedData}));
