 ...
 const [pageNo, setPageNo] = useState(1);
  ...
  useEffect(() => {
    const fetchDataFromAPI = async () => {
      try {
        const mystry = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=cfe422613b250f702980a3bbf9e90716&page=${pageNo}&sort_by=popularity.desc&with_genres=9648&year=1998`);
                const data1 = await mystry.json();
          ...
          dispatch(setApiData({mystry:combinedData}));
