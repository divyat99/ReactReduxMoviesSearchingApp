  ...
  const [moviedata, setMoviedata] = useState([]);
    ...
    useEffect(() => {
      const fetchDataFromAPI = async () => {
        try {
          const thriller = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=cfe422613b250f702980a3bbf9e90716&page=${pageNo}&sort_by=popularity.desc&with_genres=53&year=2022`);
                  const data1 = await thriller.json();
            ...
            dispatch(setApiData({thriller:combinedData}));
