    ...
    const fetchDataFromAPI = async () => {
      try {
        const drama = await fetch(
          `https://api.themoviedb.org/3/discover/movie?api_key=cfe422613b250f702980a3bbf9e90716&page=${pageNo}&sort_by=popularity.desc&with_genres=18&year=1997`);
        ...
        dispatch(setApiData({movies:combinedData}));
      } catch (error) {
        console.error(error);
      }
    };
